...
export default function PublicViewPage() {
  ...
  return (
    ...
    >
      <div className="mx-auto max-w-2xl">
        <section className="mb-6 rounded-2xl border border-slate-200 bg-white/85 p-5 shadow-sm backdrop-blur-sm">
          <p className="text-lg flex justify-center items-center font-bold uppercase tracking-[0.24em] text-black ">
            MedSecure
          </p>
          <p className="mt-2 text-sm leading-6 text-slate-400">
            MedSecure provides a secure, read-only snapshot of essential health
            details and recent logs for faster emergency access.
          </p>
        </section>
